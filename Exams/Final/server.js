...
// Create vehicles image directory if it doesn't exist
const vehiclesImageDir = path.join(__dirname, "public/images/vehicles");
if (!fs.existsSync(vehiclesImageDir)) {
  fs.mkdirSync(vehiclesImageDir, { recursive: true });
}
